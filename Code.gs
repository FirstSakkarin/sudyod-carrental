...
const HEADERS = {
  ...
  bookings:    ['id','carId','customer','phone','start','startTime','pickupLocation','end','endTime','returnLocation','mileageOut','rate','total','status','note','returnDate','returnMileage','kmDriven','extra','finalTotal','returnNote'],
